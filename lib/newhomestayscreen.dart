...
class NewHomestayRayaScreen extends StatefulWidget {
  final User user;
  final Position position;
  final List<Placemark> placemarks;
  const NewHomestayRayaScreen(
      {super.key,
      required this.user,
  ...
  @override
  State<NewHomestayRayaScreen> createState() => _NewHomestayScreenState();
}

class _NewHomestayScreenState extends State<NewHomestayRayaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("New Homestay Raya")),
  ...
  void insertHomestay() {
    ...
    http.post(Uri.parse("${Config.server}/php/insert_homestayraya.php"), body: {
